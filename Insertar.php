  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="./php/insertar.php" method="POST" class="row g-3" >
          <div class="col-12">
            <label for="c1" class="form-label">Campo1 Numerico</label>
            <input type="number" class="form-control" name="c1" id="c1" placeholder="Ingresa datos">
          </div>
          <div class="col-12">
            <label for="c2" class="form-label">Campo2 Cadena de Texto</label>
            <input type="text" class="form-control" name="c2" id="c2" placeholder="Ingresa datos">
          </div>
          <div class="col-12">
            <label for="c3" class="form-label">Campo3 Cadena de Texto</label>
